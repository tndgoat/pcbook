...
const file_storage_message_proto_rawDesc = "" +
	"\n" +
	"\x15storage_message.proto\x12\tpcbook.v1\x1a\x14memory_message.proto\"\x90\x01\n" +
	"\aStorage\x121\n" +
	"\x06driver\x18\x01 \x01(\x0e2\x19.pcbook.v1.Storage.DriverR\x06driver\x12)\n" +
	"\x06memory\x18\x02 \x01(\v2\x11.pcbook.v1.MemoryR\x06memory\"'\n" +
	"\x06Driver\x12\v\n" +
